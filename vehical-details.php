      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-envelope" aria-hidden="true"></i><a href="payment.html"></a>Book Now</h5>
          </div>
          <form method="post">
          ...
          <?php if($_SESSION['login'])
              {?>
              <div class="form-group">
               <a href="payment.html"> <input type="submit" class="btn"  name="submit" value="Book Now"></a>
              </div>
              <?php } else { ?>
